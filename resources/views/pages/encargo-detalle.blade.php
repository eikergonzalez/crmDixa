                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="block block-rounded mb-1">
                            <div class="block-header block-header-default" role="tab" id="accordion_h3">
                                <a class="fw-semibold" data-bs-toggle="collapse" data-bs-parent="#accordion" href="#accordion_q3" aria-expanded="true" aria-controls="accordion_q3">Contratos</a>
                            </div>
                                ...
                                <div class="block-content">
                                    ...
                                    <div class="row items-push js-gallery img-fluid-100">
                                        @foreach($contratos as $contrato)
                                            <div class="col-sm-12">
                                                <a href="/contrato/{{ (string)$contrato->id }}" target="_blank" >
                                                    @switch( $contrato->tipo_contrato )
                                                        @case('NOTA_ENCARGO_COMPRAVENTA')
                                                            Contrato Nota de Encargo Compraventa
                                                            @break
                                                        @case('NOTA_ENCARGO_ARRENDAMIENTO')
                                                            Contrato Nota de Encargo Arrendamiento
                                                            @break
                                                        @case('PROPUESTA_CONTRATO_COMPRAVENTA')
                                                            Propuesta de Contrato de Compraventa
                                                            @break
                                                        @case('PROPUESTA_CONTRATO_ARRENDAMIENTO')
                                                            Propuesta de Contrato de Arrendamiento
                                                            @break
                                                    @endswitch
                                                </a>
                                            </div>
