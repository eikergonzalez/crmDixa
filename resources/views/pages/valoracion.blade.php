                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <select class="js-select2 form-select" id="hipoteca" name="hipoteca" style="width: 100%;" onclick="valorHipoteca();" required data-placeholder="Seleccione..." >
                                    <option value="">Seleccione...</option>
                                    <option value="NO">NO</option>
                                    <option value="SI">SI</option>
    ...
    <script>
       var noticias = {{ Js::from($propietarios) }};
        $(document).ready(function() {
            ...
            $('#hipoteca_valor').prop('disabled','true');
        });
        ...
        function valorHipoteca() {
            var valor = $('#hipoteca').val();
            alert(valor);

            if(valor=='SI'){
                $('#hipoteca_valor').prop('disabled','false');
            }else{
                $('#hipoteca_valor').prop('disabled','true');
            }
